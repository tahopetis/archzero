    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow p-6 widget dashboard-widget" data-testid="widget-portfolio-health">
          ...
          <div className="bg-white rounded-lg shadow p-6 widget dashboard-widget" data-testid="widget-data-quality">
          ...
          <div className="bg-white rounded-lg shadow p-6 widget dashboard-widget" data-testid="widget-criticality-watch">
